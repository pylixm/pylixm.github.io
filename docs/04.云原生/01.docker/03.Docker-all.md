...
![docker_arch](/imgs/docker-on-linux.png)
...
![](/imgs/docker-execdriver-diagram.png)

图片来源: [Docker 0.9: introducing execution drivers and libcontainer](https://www.docker.com/blog/docker-0-9-introducing-execution-drivers-and-libcontainer/)
