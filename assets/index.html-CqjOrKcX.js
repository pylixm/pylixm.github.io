import{_ as n,c as a,a as i,o as e}from"./app-CGUs_8en.js";const l={};function p(r,s){return e(),a("div",null,[...s[0]||(s[0]=[i(`<p>之前启动celery时，使用nohup 方式启动。这种方式是不安全的，今天使者使用supervisor来管理监控celery，记录如下，备查。</p><h3 id="_0x00-安装-supervisor" tabindex="-1"><a class="header-anchor" href="#_0x00-安装-supervisor"><span>0x00 安装 supervisor</span></a></h3><pre><code>pip install supervisor
